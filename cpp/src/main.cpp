...
colour3 ray_color(const Ray& r, const Hittable& world) {
  Hit_record rec;
  if (world.hit(r, 0, infinity, rec)) {
    return 0.5*(rec.normal + colour3(1, 1, 1));
  }
...
int main() {
  ...
  Hittable_list world;
  world.add(make_shared<Sphere>(point3(0,0,-1), 0.5));      // a sphere in the center
